...
export const mockDishes: Dish[] = [
  {
    id: 'dish-1',
    name: 'Party-Sized Paella',
    description: 'A festive and impressive paella for 10-12 people, brimming with saffron-infused rice, chorizo, chicken, and fresh seafood.',
    price: 150.00,
  ...
  {
    id: 'dish-5',
    name: 'Taco Bar for 20',
    description: 'Everything you need for a build-your-own taco feast! Includes seasoned ground beef, grilled chicken, fresh tortillas, and all the toppings.',
    price: 250.00,
    imageUrl: 'https://placehold.co/600x400.png',
    provider: mockUsers[0],
    rating: 4.8,
  ...
  },
  {
    ...
    description: 'A beautifully arranged platter of assorted cheeses, cured meats, olives, fruits, and nuts. Perfect for any gathering.',
    price: 95.00,
    ...
    category: 'Appetizer',
    serviceType: 'catering',
    'data-ai-hint': 'charcuterie board',
    deliveryOptions: ['pickup', 'drop-off'],
  },
  {
    id: 'dish-10',

        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button size="lg" onClick={() => handleActionClick(handleOrder)}>Order Now</Button>
              <Button size="lg" variant="outline" onClick={() => handleActionClick(handleAskQuestion)}>
      ...
      <AlertDialog open={showAuthDialog} onOpenChange={setShowAuthDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              To order dishes or contact cooks, you need to be logged in. Please sign up or log in to continue.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
